		...
		if (DestItem->sIndex != 3505 && SrcItem->sIndex != 3505 && DestItem->sIndex != 4144 && SrcItem->sIndex != 4144 && DestItem->sIndex != 3980 || m->DestPlace != ITEM_PLACE_CARRY && m->SrcPlace != ITEM_PLACE_CARRY)
		{
			...
			if (Can && YouCan)
			{
				...
				if ((save1.sIndex == save2.sIndex && save1.sIndex == 413
					...
					|| save1.sIndex == save2.sIndex && save1.sIndex == 3314
					|| save1.sIndex == save2.sIndex && save1.sIndex == 3204
					...
					|| save1.sIndex == save2.sIndex && save1.sIndex == 3321
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2420
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2421
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2422
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2423
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2424
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2425
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2426
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2427
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2428
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2429
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2430
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2436
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2437
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2438
					|| save1.sIndex == save2.sIndex && save1.sIndex == 2439
				...
				if ((save1.sIndex == save2.sIndex && save1.sIndex == 4011)
					&& BASE_GetItemAmount(&save1) < 2 && BASE_GetItemAmount(&save2) < 2)
				{
					int amount1 = BASE_GetItemAmount(&save1);
					int amount2 = BASE_GetItemAmount(&save2);
					int tamount = (amount1 <= 0 ? 1 : amount1) + (amount2 <= 0 ? 1 : amount2);
					...
					else if (tamount >= 2)
					{
						...
						if (tamount >= 1)
							BASE_SetItemAmount(&save2, tamount > 2 ? 2 : tamount);
