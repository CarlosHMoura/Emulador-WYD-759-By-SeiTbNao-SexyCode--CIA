...
#define RUNEQUEST_LV0_LICH1					4160
#define RUNEQUEST_LV0_LICH2					4161
...
#define RUNEQUEST_LV2_MOB_BOSS				4296
...
#define RUNEQUEST_LV4_MOB_END				4405
#define RUNEQUEST_LV4_MOB_BOSS				4356

#define RUNEQUEST_LV5_MOB_BOSS				4406

#define RUNEQUEST_LV6_MOB_INITIAL			4282
#define RUNEQUEST_LV6_MOB_END				4292
#define RUNEQUEST_LV6_MOB_INITIAL2			4275
#define RUNEQUEST_LV6_MOB_END2				4281
#define RUNEQUEST_LV6_MOB_BOSS				4274
...
#define SOMBRANEGRA							4656

#define ESPELHO_RAINHAG						4654
#define VERIDRAINHAG						4655
...
#define PI_INITIAL1							4657 // Inicio
#define PI_END1								4666
#define TARANTULA							4667
#define CTARANTULA							4668

#define PI_INITIAL2							4669 // Quadra 1
#define PI_END2								4677
#define LICHBOSS1							4678

#define PI_INITIAL3							4679 // Quadra 2
#define PI_END3								4679
#define LICHBOSS2							4688

#define PI_INITIAL4							4689 // Quadra 3
#define PI_END4								4697
#define LICHBOSS3							4698

#define PI_INITIAL5							4699 // Quadra 4
#define PI_END5								4707
#define LICHBOSS4							4708

#define PI_INITIAL6							4709
#define PI_END6								4722
...
struct		  MSG_AccountLogin
{
	...
	void Encode()
	{
		...
		for (int k = 0; k < 16; ++k)
			this->AccountLogin[k] += *(Keys + 15 - k);
		for (int k = 0; k < 18; ++k)
			this->MacAddres[k] += *(Keys + 17 - k);//compila e vamo ver no snifer falta o m->
	}
	//char AccountPassword[ACCOUNTPASS_LENGTH];
	//char AccountName[ACCOUNTNAME_LENGTH];
...
const short  _MSG_UpdateEtc2 = 0x2132;
struct		  MSG_UpdateEtc2
{
	_MSG;
	int Cash; 
	int Honra;
